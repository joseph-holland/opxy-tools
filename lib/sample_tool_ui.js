    ...
    advancedBtn.addEventListener('click', function() {
        ...
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-body">
                ...
                <input type="range" class="form-range adv-tune-slider" min="-48" max="48" value="${tempSettings.tune}" step="1">
                <input type="number" class="form-control form-control-sm adv-tune" min="-48" max="48" value="${tempSettings.tune}">
                </div>
                <div class="mb-3">
                <label class="form-label">Pan:</label>
                <input type="range" id="advancedPanSlider" class="form-range" min="-100" max="100" value="${tempSettings.pan}" step="1">
