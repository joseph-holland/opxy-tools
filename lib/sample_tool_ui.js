...
for (let i = 1; i <= NUM_DRUMS; i++) {
    ...
    advancedBtn.addEventListener('click', function() {
        ...
        modal.className = 'modal fade'; // Remove 'show' initially
        ...
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-body">
                ...
                <input type="range" class="form-range adv-gain-slider" min="-30" max="20" value="${tempSettings.gain}" step="1" style="accent-color:#222;background:#fff;width:100%;height:2.2em;border-radius:8px;outline:none;box-shadow:none;">
                <input type="number" class="form-control form-control-sm adv-gain" min="-30" max="20" value="${tempSettings.gain}">
                </div>
                <div class="mb-3">
...
// === Advanced Modal Transition Styles ===
const advModalTransitionStyle = document.createElement('style');
advModalTransitionStyle.textContent = `
#advanced-modal.modal.fade {
  opacity: 0;
  transition: opacity 0.3s linear;
}
#advanced-modal.modal.fade.show {
  opacity: 1;
}
...
#advanced-modal.modal.fade.show .modal-dialog {
  transform: translateY(0) scale(1);
}
`;
document.head.appendChild(advModalTransitionStyle);
