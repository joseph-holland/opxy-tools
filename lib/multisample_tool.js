...
function createMultisampleRow(sampleIndex) {
  ...
  if (!sampleData.isLoading && sampleData.audioBuffer) {
    ...
    const fileSizeKB = (sampleData.fileSize / 1024).toFixed(1);
    ...
    labelBox.appendChild(sampleInfo);
  }
