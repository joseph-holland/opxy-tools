        ...
        octaveKeys.push(
          <div
            ...
            style={{
              ...
              width: '20px',
              height: '80px',
              backgroundColor: isDragOver ? '#dbeafe' : isAssigned ? '#4ade80' : isHovered ? '#f3f4f6' : '#ffffff',
        ...
        octaveKeys.push(
          <div
            ...
            style={{
              ...
              width: '12px',
              height: '50px',
              backgroundColor: isDragOver ? '#60a5fa' : isAssigned ? '#22c55e' : isHovered ? '#374151' : '#1f2937',
              border: isDragOver ? '2px solid #3b82f6' : '1px solid #111827',
